...
for epoch in range(epochs):
    ...
    with open("log-edu.txt", 'a') as fd:
        fd.write(f"{print_statement}\n")

    print(print_statement)


torch.save(model.state_dict(), "./model1-edu_weights.pth")
torch.save(optimizer.state_dict(), "./optimizer1-edu_weights.pth")